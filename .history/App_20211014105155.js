  ...
  render() {
    return (
      <View style={{ margin: 20 }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between',marginTop:15 }} onPress={() => this.onButtonClicked(4)}>
          <TouchableOpacity style={{borderColor:'grew',borderWidth:2,flex:1}}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between',marginTop:15 }} onPress={() => this.onButtonClicked(1)}>
          <TouchableOpacity style={{borderColor:'grew',borderWidth:2,flex:1}}>

...
export default class App extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      calculResult: '0',firstNumber: '',secondNumber:'',signe: '',
    }
  }
  onResetClicked()
  {
  ...
  onEqualsClicked()
  {
    if(this.state.firstNumber.trim()!='' && this.state.secondNumber.trim()!='' && this.state.signe.trim()!='' )
    {
      if(this.state.signe == '+')
      {
        var resultValue = this.state.firstNumber + this.state.secondNumber;
        this.setState({calculResult:resultValue,firstNumber: '',secondNumber:'',signe: '',});
        return;
      }
  ...
  onButtonClicked(numberValue)
  {
    ...
    else if(this.state.firstNumber.trim()!='' && this.state.signe.trim()!='' )
    {
